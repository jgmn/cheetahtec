...
<div class="breadcrumb_area" style="background-image: url(/img/14.jpg)">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<h1>Fábrica de Software SAP-ABAP</h1>
				<ul class="brc">
					<li><a href="{{url('/')}}">Inicio</a></li>
					<li><a href="{{url('/services')}}">Servicios</a></li>
					<li><span>Fábrica de Software SAP-ABAP<span></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<aside class="col-md-3">
				<div class="widget widget_service wow fadeInUp">
					<ul>
						<li class="active"><a href="#">Fábrica SAP-ABAP</a></li>
			...
			<div class="col-md-4">
				<div class="service_content wow fadeInUp">
					<div class="service_gallery clearfix">
						<div class="tile" style="background-image: url(/img/06-2.jpg)" ></div>
					</div>
				</div>
			</div>
		</div>
