...
<div class="breadcrumb_area" style="background-image: url(/img/14.jpg)">
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<h1>Desarollo Java</h1>
				<ul class="brc">
					<li><a href="{{url('/')}}">Inicio</a></li>
					<li><a href="{{url('/services')}}">Servicios</a></li>
					<li><span>Desarrollo Java<span></li>
				</ul>
			</div>
		</div>
	</div>
			...
			<aside class="col-md-3">
				<div class="widget widget_service wow fadeInUp">
					<ul>
						...
						<li class="active"><a href="{{url('services/java-development')}}">Desarrollo Java</a></li>
			...
			<div class="col-md-4">
				<div class="service_content wow fadeInUp">
					<div class="service_gallery clearfix">
						<div class="tile" style="background-image: url(/img/15.jpg)"></div>
					</div>
				</div>
			</div>
		</div>
